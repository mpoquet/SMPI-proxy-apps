...
#+BEGIN_SRC sh :tangle bin/Prime.sh
     ...
     echo "Install the modified sources"
     cp ../src/CodeVault/prime/* CodeVault/hpc_kernel_samples/monte_carlo_methods/prime/
     cp ../src/common/* CodeVault/hpc_kernel_samples/monte_carlo_methods/prime/

     echo "Compile it"
     cd CodeVault/hpc_kernel_samples/monte_carlo_methods/
     mkdir build
     cd build/
     cmake -Denable smpi=on ..
     make 
