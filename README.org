...
| [[https://github.com/Zitagcc/SMPI-benchmarks/blob/master/main.org#kmi_hash][KMI_HASH]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/KMI_Summary_v1.1.pdf][:book:]] [[https://asc.llnl.gov/CORAL-benchmarks/Datacentric/KMI_HASH_CORAL.tar.gz][:package:]]| / | MPI | C | :white_check_mark: :partly_sunny: | :white_check_mark: | :x: | Building issue |
...
| Benchmark  | Reference | Lines of code | paral | Lang | Build with MPI | Run with MPI | Build with SMPI | about SMPI test |
|------------+-----------+---------------+-------+------+----------------+--------------+---------+-----------------|
| [[https://github.com/Zitagcc/SMPI-benchmarks/blob/master/main.org#minixcye][MiniXcye]]   | NONE [[http://mantevo.org/downloads/miniXyce_1.0.html][MiniXcye]] | unknown       | MPI         | C++     | :white_check_mark: :partly_sunny:                                                                          | :white_check_mark: | :white_check_mark: | runing issue                    |
| [[https://github.com/Zitagcc/SMPI-benchmarks/blob/master/main.org#minismac2d][MiniSMAC2D]] | NONE [[http://mantevo.org/downloads/miniSMAC2D_2.0.html][MiniSMAC2D]] | unknown       | MPI, OPENMP | F90 | :white_check_mark: :wrench: :partly_sunny: | :white_check_mark: | :white_check_mark:     | but it got "killing simulation" |
